...
Steps to run
Extract the submitted zip and move to code directory.
Run mvn clean install inside the directory. This command might take some time as maven downloads all the project dependencies.
Run logserver using the log4j-server.xml file. The command for this is:
